...
namespace ImGui
{
    ...
    IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0,0), bool hide = false);    // button
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v, float szModifier = 2.0f);
    ...
    IMGUI_API bool          ColorEdit4(const char* label, float col[4], ImGuiColorEditFlags flags = 0, ImVec2 size = ImVec2(0,0));
    ...
    IMGUI_API bool          TreeNode(const char* label, bool* _outClicked = NULL, ImGuiTreeNodeFlags _flags = 0);
...
enum ImGuiWindowFlags_
{
	...
	ImGuiWindowFlags_BringFoward			= 1 << 29
    // [Obsolete]
