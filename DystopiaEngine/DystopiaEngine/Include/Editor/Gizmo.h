...
namespace EGUI
{
	namespace Gizmo2D
	{
		...
		eDragStatus ScalarLeft(const std::string& _uniqueID, float& _outputValX, const Math::Vec2& _origin = Math::Vec2{ 0,0 }, float _vSpeed = 1.f,
			const Math::Vec4& _col = Math::Vec4{ 1,1,1,1 }, bool* _pHovered = nullptr, float _len = 40.f, float _thickness = 12.f);

		eDragStatus ScalarUp(const std::string& _uniqueID, float& _outputValY, const Math::Vec2& _origin = Math::Vec2{ 0,0 }, float _vSpeed = 1.f,
			const Math::Vec4& _col = Math::Vec4{ 1,1,1,1 }, bool* _pHovered = nullptr, float _len = 40.f, float _thickness = 12.f);
