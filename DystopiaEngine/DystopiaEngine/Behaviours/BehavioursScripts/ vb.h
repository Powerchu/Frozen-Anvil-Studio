...
namespace Dystopia
{
	...
	{
	public:
		static constexpr const char * BehaviourName = str( vb);
#if !EDITOR
...
#endif
		virtual const std::string GetEditorName(void) const override { return " vb"; }
		static uint64_t constexpr m vbID = 18446744073428012032;
...
PP_REFLECT_EMPTY(Dystopia:: vb)
/*
  Uncomment the line PP_REFLECT and add in the names of the variable you want to show
  Comment out PP_REFLECT_EMPTY.
*/
//PP_REFLECT(Dystopia:: vb)
