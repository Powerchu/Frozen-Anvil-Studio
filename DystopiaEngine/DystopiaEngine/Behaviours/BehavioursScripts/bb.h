...
namespace Dystopia
{
	...
	{
	public:
		static constexpr const char * BehaviourName = str(bb);
#if !EDITOR
...
#endif
		virtual const std::string GetEditorName(void) const override { return "bb"; }
		static uint64_t constexpr mbbID = 18446744073216200192;
...
PP_REFLECT_EMPTY(Dystopia::bb)
/*
  Uncomment the line PP_REFLECT and add in the names of the variable you want to show
  Comment out PP_REFLECT_EMPTY.
*/
//PP_REFLECT(Dystopia::bb)
