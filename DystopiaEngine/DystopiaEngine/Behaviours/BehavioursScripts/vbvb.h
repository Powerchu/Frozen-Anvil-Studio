...
namespace Dystopia
{
	class vbvb : Behaviour
	{
	public:
		static constexpr const char * BehaviourName = str(vbvb);
#if !EDITOR
...
#endif
		virtual const std::string GetEditorName(void) const override { return "vbvb"; }
		static uint64_t constexpr mvbvbID = 18446744072321764864;
	...
	private:
		// Don't touch
		friend MetaData<vbvb>;
	};

	extern "C"
	{
		DllExport vbvb * vbvbClone()
		{
			return new vbvb;
		}
	}
...
//PP_REFLECT_EMPTY(Dystopia::vbvb)
/*
  Uncomment the line PP_REFLECT and add in the names of the variable you want to show
  Comment out PP_REFLECT_EMPTY.
*/
PP_REFLECT(Dystopia::vbvb, h)
