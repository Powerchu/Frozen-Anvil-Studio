...
namespace Dystopia
{
	class ngng : Behaviour
	{
	public:
		static constexpr const char * BehaviourName = str(ngng);
#if !EDITOR
...
#endif
		virtual const std::string GetEditorName(void) const override { return "ngng"; }
		static uint64_t constexpr mngngID = 2069367808;
	...
	private:
		// Don't touch
		friend MetaData<ngng>;
	};

	extern "C"
	{
		DllExport ngng * ngngClone()
		{
			return new ngng;
		}
	}
...
PP_REFLECT_EMPTY(Dystopia::ngng)
/*
  Uncomment the line PP_REFLECT and add in the names of the variable you want to show
  Comment out PP_REFLECT_EMPTY.
*/
//PP_REFLECT(Dystopia::ngng)
