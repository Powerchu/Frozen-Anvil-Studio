...
namespace Dystopia
{
	...
	class FormSlam : public Behaviour
	{
	public:
		static constexpr const char * BehaviourName = str(FormSlam);
#if !EDITOR
...
#endif
		virtual const std::string GetEditorName(void) const override { return "FormSlam"; }
		static uint64_t constexpr mFormSlamID = 390654464;
		...
		// Don't touch
		virtual FormSlam * Duplicate() const;
		...
		PP_MEMBERFUNC(Dystopia::FormSlam, SetKnockDirection, SetFacing, StartSkill)
		
		bool mbActivate;
		
	private:
		// Don't touch
		friend MetaData<FormSlam>;
	...
	extern "C"
	{
		inline DllExport FormSlam * FormSlamClone()
		{
			return new FormSlam;
		}
	}
...
//PP_REFLECT_EMPTY(Dystopia::FormSlam)
/*
  Uncomment the line PP_REFLECT and add in the names of the variable you want to show
  Comment out PP_REFLECT_EMPTY.
*/
PP_REFLECT_STUFF(Dystopia::FormSlam, mbActivate);
