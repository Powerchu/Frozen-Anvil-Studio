...
namespace Dystopia
{
	...
	void Dystopia::FloorChecker::OnTriggerEnter(const GameObject * _obj)
	{
	}

	void Dystopia::FloorChecker::OnTriggerStay(const GameObject * _obj)
	{
	}

	void Dystopia::FloorChecker::OnTriggerExit(const GameObject * _obj)
	{
	}
