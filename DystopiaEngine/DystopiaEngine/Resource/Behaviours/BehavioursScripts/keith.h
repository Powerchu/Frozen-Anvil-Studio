...
namespace Dystopia
{
	class keith : Behaviour
	{
	public:
		static constexpr const char * BehaviourName = str(keith);
#if !EDITOR
...
#endif
		virtual const std::string GetEditorName(void) const override { return "keith"; }
		static uint64_t constexpr mkeithID = 2100825088;
	...
	private:
		// Don't touch
		friend MetaData<keith>;
	};

	extern "C"
	{
		DllExport keith * keithClone()
		{
			return new keith;
		}
	}
...
PP_REFLECT_EMPTY(Dystopia::keith)
/*
  Uncomment the line PP_REFLECT and add in the names of the variable you want to show
  Comment out PP_REFLECT_EMPTY.
*/
//PP_REFLECT(Dystopia::keith)
