...
namespace Dystopia
{
	class TestB : Behaviour
	{
	public:
		static constexpr const char * BehaviourName = str(TestB);
#if !EDITOR
...
#endif
		virtual const std::string GetEditorName(void) const override { return "TestB"; }
		static uint64_t constexpr mTestBID = 375393792;
	...
	private:
		// Don't touch
		friend MetaData<TestB>;
	};

	extern "C"
	{
		DllExport TestB * TestBClone()
		{
			return new TestB;
		}
	}
...
PP_REFLECT_EMPTY(Dystopia::TestB)
/*
  Uncomment the line PP_REFLECT and add in the names of the variable you want to show
  Comment out PP_REFLECT_EMPTY.
*/
//PP_REFLECT(Dystopia::TestB)
