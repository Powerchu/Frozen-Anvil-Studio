...
namespace Dystopia
{
	class SpriteManager : public Behaviour
	{
	public:
		static constexpr const char * BehaviourName = str(SpriteManager);
#if !EDITOR
...
#endif
		virtual const std::string GetEditorName(void) const override { return "SpriteManager"; }
		static uint64_t constexpr mSpriteManagerID = 1950080000;
		...
		// Don't touch
		virtual SpriteManager * Duplicate() const;
	...
	extern "C"
	{
		inline DllExport SpriteManager * SpriteManagerClone()
		{
...
PP_REFLECT_EMPTY(Dystopia::SpriteManager)
/*
Uncomment the line PP_REFLECT and add in the names of the variable you want to show
Comment out PP_REFLECT_EMPTY.
*/
//PP_REFLECT(Dystopia::SpriteManager)
