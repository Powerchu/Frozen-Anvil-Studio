...
namespace Dystopia
{
	...
	{
	public:
		static constexpr const char * BehaviourName = str(SplashScreen);
#if !EDITOR
...
#endif
		virtual const std::string GetEditorName(void) const override { return "SplashScreen"; }
		static uint64_t constexpr mSplashScreenID = 18446744072878187520;
		...
		// Don't touch
		virtual SplashScreen * Duplicate() const;
	...
	extern "C"
	{
		inline DllExport SplashScreen * SplashScreenClone()
		{
...
//PP_REFLECT_EMPTY(Dystopia::SplashScreen)
/*
  Uncomment the line PP_REFLECT and add in the names of the variable you want to show
  Comment out PP_REFLECT_EMPTY.
*/
PP_REFLECT(Dystopia::SplashScreen, delay, count);
