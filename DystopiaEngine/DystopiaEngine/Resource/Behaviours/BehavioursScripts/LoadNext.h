...
namespace Dystopia
{
	class LoadNext : public Behaviour
	{
	public:
		static constexpr const char * BehaviourName = str(LoadNext);
#if !EDITOR
...
#endif
		virtual const std::string GetEditorName(void) const override { return "LoadNext"; }
		static uint64_t constexpr mLoadNextID = 1991261184;
		...
		// Don't touch
		virtual LoadNext * Duplicate() const;
	...
	private:
		// Don't touch
		friend MetaData<LoadNext>;
	};

	extern "C"
	{
		inline DllExport LoadNext * LoadNextClone()
		{
			return new LoadNext;
		}
	}
...
PP_REFLECT_EMPTY(Dystopia::LoadNext)
/*
Uncomment the line PP_REFLECT and add in the names of the variable you want to show
Comment out PP_REFLECT_EMPTY.
*/
//PP_REFLECT(Dystopia::LoadNext)
