...
namespace Dystopia
{
	...
	{
	public:
		static constexpr const char * BehaviourName = str(Health);
#if !EDITOR
...
#endif
		virtual const std::string GetEditorName(void) const override { return "Health"; }
		static uint64_t constexpr mHealthID = 18446744072882085888;
		...
		// Don't touch
		virtual Health * Duplicate() const;
	...
	private:
		// Don't touch
		friend MetaData<Health>;
	};

	extern "C"
	{
		inline DllExport Health * HealthClone()
		{
			return new Health;
		}
	}
...
PP_REFLECT_EMPTY(Dystopia::Health)
/*
Uncomment the line PP_REFLECT and add in the names of the variable you want to show
Comment out PP_REFLECT_EMPTY.
*/
//PP_REFLECT(Dystopia::Health)
