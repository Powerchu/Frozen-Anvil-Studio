...
namespace Dystopia
{
	class PauseManager : public Behaviour
	{
	public:
		static constexpr const char * BehaviourName = str(PauseManager);
#if !EDITOR
...
#endif
		virtual const std::string GetEditorName(void) const override { return "PauseManager"; }
		static uint64_t constexpr mPauseManagerID = 318782976;
		...
		// Don't touch
		virtual PauseManager * Duplicate() const;
	...
	extern "C"
	{
		inline DllExport PauseManager * PauseManagerClone()
		{
...
PP_REFLECT_EMPTY(Dystopia::PauseManager)
/*
Uncomment the line PP_REFLECT and add in the names of the variable you want to show
Comment out PP_REFLECT_EMPTY.
*/
//PP_REFLECT(Dystopia::PauseManager)
