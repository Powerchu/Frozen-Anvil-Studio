...
namespace Dystopia
{
	...
	namespace Hotkey
	{
		static constexpr unsigned short g_KeyUndo[g_CountDefault] = { eButton::KEYBOARD_LCTRL, eButton::KEYBOARD_Z };
		static constexpr eHotkeyState g_StateUndo[g_CountDefault] = { eHotkeyState::eHOTKEY_HOLD, eHotkeyState::eHOTKEY_TRIGGERED };

		static constexpr unsigned short g_KeyRedo[g_CountDefault] = { eButton::KEYBOARD_LCTRL, eButton::KEYBOARD_Y };
		static constexpr eHotkeyState g_StateRedo[g_CountDefault] = { eHotkeyState::eHOTKEY_HOLD, eHotkeyState::eHOTKEY_TRIGGERED };

		static constexpr unsigned short g_KeyCopy[g_CountDefault] = { eButton::KEYBOARD_LCTRL, eButton::KEYBOARD_C };
		static constexpr eHotkeyState g_StateCopy[g_CountDefault] = { eHotkeyState::eHOTKEY_HOLD, eHotkeyState::eHOTKEY_TRIGGERED };

		static constexpr unsigned short g_KeyPaste[g_CountDefault] = { eButton::KEYBOARD_LCTRL, eButton::KEYBOARD_V };
		static constexpr eHotkeyState g_StatePaste[g_CountDefault] = { eHotkeyState::eHOTKEY_HOLD, eHotkeyState::eHOTKEY_TRIGGERED };

		static constexpr unsigned short g_KeyOpen[g_CountDefault] = { eButton::KEYBOARD_LCTRL, eButton::KEYBOARD_O };
		static constexpr eHotkeyState g_StateOpen[g_CountDefault] = { eHotkeyState::eHOTKEY_HOLD, eHotkeyState::eHOTKEY_TRIGGERED };

		static constexpr unsigned short g_KeyPlayStop[g_CountDefault] = { eButton::KEYBOARD_LCTRL, eButton::KEYBOARD_P };
		static constexpr eHotkeyState g_StatePlayStop[g_CountDefault] = { eHotkeyState::eHOTKEY_HOLD, eHotkeyState::eHOTKEY_TRIGGERED };

		static constexpr unsigned short g_KeySave[g_CountDefault] = { eButton::KEYBOARD_LCTRL, eButton::KEYBOARD_S };
		static constexpr eHotkeyState g_StateSave[g_CountDefault] = { eHotkeyState::eHOTKEY_HOLD, eHotkeyState::eHOTKEY_TRIGGERED };

		static constexpr unsigned short g_KeySaveAs[g_CountSaveAs] = { eButton::KEYBOARD_LCTRL, eButton::KEYBOARD_LSHIFT, eButton::KEYBOARD_S };
		...
		static constexpr unsigned short g_KeyDelete[g_CountDefault] = { eButton::KEYBOARD_LCTRL, eButton::KEYBOARD_DELETE };
		static constexpr eHotkeyState g_StateDelete[g_CountDefault] = { eHotkeyState::eHOTKEY_NEGATE, eHotkeyState::eHOTKEY_TRIGGERED };

		static constexpr unsigned short g_KeyGizmoTrans[g_CountGizmo] = { eButton::KEYBOARD_LCTRL, eButton::KEYBOARD_LALT, eButton::KEYBOARD_W };
		...
		static constexpr unsigned short g_KeyGizmoScale[g_CountGizmo] = { eButton::KEYBOARD_LCTRL, eButton::KEYBOARD_LALT, eButton::KEYBOARD_E };
